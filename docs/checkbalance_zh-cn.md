...
2. 快照包含在Compound平台质押的USDT，您可以使用[Compound API](https://api.compound.finance/api/v2/account?addresses%5B%5D=0xb99cc7e10fe0acc68c50c7829f473d81e23249cc&block_number=16023042)进行验证。此部分的USDT配置如下：
